...
function mapFeedback(id: string, data: Record<string, unknown>): Feedback {
  return {
    ...
    viewport: data.viewport ? String(data.viewport) : undefined,
    captureMode: data.captureMode ? String(data.captureMode) : undefined,
    extensionVersion: data.extensionVersion ? String(data.extensionVersion) : undefined,
    referrer: data.referrer ? String(data.referrer) : undefined,
    timezone: data.timezone ? String(data.timezone) : undefined,
    consoleSnippet: data.consoleSnippet ? String(data.consoleSnippet) : undefined,
